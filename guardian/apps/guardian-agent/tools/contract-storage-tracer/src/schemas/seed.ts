 ...
 * storage the call touches, which is what lets the tracer bound each caller set (see
 * docs/ARCHITECTURE.md §4). A tx hash, if provided, is reduced to this shape upstream.
 */
