// Note: This is a copied version of the observe function from viem
// https://github.com/wevm/viem/blob/aca3e1d75d979aa50f5737a2fabaf0088b160f46/src/utils/observe.ts
...
export function observe<callbacks extends Callbacks>(
  ...
  for (const key in callbacks) {
    emit[key] = ((...args: Parameters<NonNullable<callbacks[keyof callbacks]>>) => {
      const listeners = getListeners();
